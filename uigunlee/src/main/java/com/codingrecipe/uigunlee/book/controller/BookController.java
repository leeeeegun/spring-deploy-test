package com.codingrecipe.uigunlee.book.controller;

import com.codingrecipe.uigunlee.book.controller.request_form.RegisterBookRequestForm;
import com.codingrecipe.uigunlee.book.controller.response_form.RegisterBookResponseForm;
import com.codingrecipe.uigunlee.book.service.BookService;
...
public class BookController {
    ...
    public RegisterBookResponseForm registerBook(
        ...
        // 책등록이 잘 되었는지 read 혹은 필요에 따라 list에 적합한 응답 구성
